    ...
    useEffect(() => {
        ...
        const fetchRelatedProducts = async () => {
            try {
                ...
                const filteredProducts = data.filter(p => p.Category === "rudraksha").slice(0, 8);
                    ...
                    {loading ? (
                        ...
                        <div className="cards">
                            {relatedProducts.map((p) => (
                                <Link key={p._id} to={`/rudraksha/product/${p._id}`}>
                                    <div className="card">
                                        <div className="img">
...
export default RudrakshaProduct;
